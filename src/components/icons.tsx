// Small inline SVG icons (monochrome, inherit `currentColor`). Feather-style.
interface IconProps {
  size?: number;
}
...
export function IconZap({ size = 15 }: IconProps) {
  return (
    <svg {...base(size)}>
...
export function IconRestore({ size = 15 }: IconProps) {
  return (
    <svg {...base(size)}>
...
export function IconCheckMark({ size = 15 }: IconProps) {
  return (
    <svg {...base(size)}>
